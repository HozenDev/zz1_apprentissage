...
#define MUTATION_RATE_DISTANCE_FRIEND     0.005
#define MUTATION_RATE_DISTANCE_TARGET     0.005
#define MUTATION_RATE_CARDINALITY_FRIEND  0.005
#define MUTATION_RATE_CARDINALITY_TARGET  0.005
#define MUTATION_RATE_DISTANCE  0.005
